...
enhance this script by incorporating handling for the BotoCoreError, a type of exception that symbolizes errors within Boto3 
itself. In case of a BotoCoreError, print this message: 'Unexpected Boto3 error: {error_message}'.
'''
...
# TODO: Handle possible Boto3 internal errors.
    ...
    print('Unexpected Boto3 error:', e)